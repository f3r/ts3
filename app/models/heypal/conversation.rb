class Heypal::Conversation < Heypal::Base
  ...
  # TODO: Fix validation
  # validates :to, :city, :country, :zip, :presence => true

  class << self
    def list(params = {})
      result = request("/conversations.json?access_token=#{params['access_token']}", :get, params)
      if result['conversations']
        self.new(result['conversations'])
      end
    end
