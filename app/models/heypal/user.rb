class Heypal::User < Heypal::Base
  ...
  @@attributes = %w(first_name last_name gender email password password_confirmation terms oauth_provider oauth_token oauth_uid phone_mobile birthdate access_token)
