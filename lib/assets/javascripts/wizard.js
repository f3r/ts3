...
var validatePlace = function(panelStatus) {
  ...
  if(validCategories == 5) {
    ...
    $('#listing-status').attr('rel', 'tooltip');
...
var validatePanels = function(target) {
  ...
  if(panelErrors.general)   { wizard_aside.find('#generalInfo img').attr('src',   '/images/check.png');          }
  else                      { wizard_aside.find('#generalInfo img').attr('src',   '/images/check-disabled.png'); }
  if(panelErrors.photos)    { wizard_aside.find('#photoInfo img').attr('src',    '/images/check.png');          }
  else                      { wizard_aside.find('#photoInfo img').attr('src',    '/images/check-disabled.png'); }
  if(panelErrors.amenities) { wizard_aside.find('#amenitiesInfo img').attr('src', '/images/check.png');          }
  else                      { wizard_aside.find('#amenitiesInfo img').attr('src', '/images/check-disabled.png'); }
  if(panelErrors.price)     { wizard_aside.find('#priceInfo img').attr('src',     '/images/check.png');          }
  else                      { wizard_aside.find('#priceInfo img').attr('src',     '/images/check-disabled.png'); }
